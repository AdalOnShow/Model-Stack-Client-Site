...
const EditeModel = () => {
  ...
  const { name, framework, dataset, useCase, image, description, createdBy } =
    model;
  ...
  return (
    <div className="max-w-7xl mx-auto py-16 px-6">
      ...
      <form
        onSubmit={(e) => handleUpdateModelForm(e)}
        className="max-w-xl mx-auto flex flex-col bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm"
      >
