    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex flex-col items-center justify-center min-h-screen py-16">
        <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-xl shadow-sm p-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 text-center">Register for Model Stack</h2>
          <form onSubmit={(e) => handleRegister(e)} className="flex flex-col space-y-4">
            <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-center mt-4">
              ...
              <Link className="text-indigo-600 hover:text-indigo-500 font-medium" to="/login">
                Login here
              </Link>
            </p>
          </form>
